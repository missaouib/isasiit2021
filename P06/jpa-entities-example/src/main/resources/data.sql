insert into student (index_number, first_name, last_name) values ('ra1-2014', 'Pera', 'Peric');
...
--insert into course_set (name) values ('Matematika');
--insert into course_set (name) values ('Osnove programiranja');
--insert into course_set (name) values ('Objektno programiranje');
--
--insert into teacher_set (first_name, last_name) values ('Strahinja', 'Simić');
--insert into teacher_set (first_name, last_name) values ('Marina', 'Antić');
--insert into teacher_set (first_name, last_name) values ('Siniša', 'Branković');
--
--insert into teaching_set (course_id, teacher_id) values (1, 1);
--insert into teaching_set (course_id, teacher_id) values (1, 2);
--insert into teaching_set (course_id, teacher_id) values (2, 2);
--insert into teaching_set (course_id, teacher_id) values (3, 3);
